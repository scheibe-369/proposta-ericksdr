  ...
  ({ asChild = false, className, children, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          "relative flex shrink-0 items-center justify-center rounded-full bg-muted text-xs font-medium text-muted-foreground data-[state=active]:bg-primary/20 data-[state=active]:text-primary data-[state=completed]:bg-primary/20 data-[state=completed]:text-primary data-[state=inactive]:bg-primary/10 data-[state=inactive]:text-primary/60",
          className,
        )}
        data-state={state}
        {...props}
